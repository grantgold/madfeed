  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-11 col-sm-offset-1">
        ...
        <hr>
        <div class="col-xs-4 medium-top-btm-padding img-responsive about-illo"><img src="<?php echo get_template_directory_uri(); ?>/img/illo/about.jpg"></div>
      ...
      <div class="col-xs-12">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4">
            ...
            <a class="twitter-name" href="http://twitter.com/">@</a>
  ...
  <div id="contact-info" class="container">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-2 col-sm-offset-1">
        <div class="img-responsive about"><img src="<?php echo get_template_directory_uri(); ?>/img/illo/onion.png"></div>
      </div>
    </div>
  </div>
